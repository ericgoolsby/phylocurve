...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(C_ultrafast(nedge, L, E, pic_ace, ace_hat, var_hat, len_vec, pic_len_vec));
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(multipic(ntip, nnode, edge1, edge2, edge_len, phe, contr, var_contr, scaled, pic_len, pic_recon));
    return rcpp_result_gen;
END_RCPP
}
// multipic2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type pic_len(pic_lenSEXP);
    Rcpp::traits::input_parameter< int >::type pic_recon(pic_reconSEXP);
    rcpp_result_gen = Rcpp::wrap(multipic2(ntip, nnode, edge1, edge2, edge_len, phe, contr, var_contr, scaled, pic_len, pic_recon));
    return rcpp_result_gen;
END_RCPP
}
// logdet
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(logdet(A));
    return rcpp_result_gen;
END_RCPP
}
// Rinv4
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Rinv4(nspecies, nedge, ngroups, ind, len_vec, anc, des, R, painted_edges, phylocovs, REML));
    return rcpp_result_gen;
END_RCPP
}
// Rinv6
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat >::type phylocovs(phylocovsSEXP);
    Rcpp::traits::input_parameter< int >::type REML(REMLSEXP);
    rcpp_result_gen = Rcpp::wrap(Rinv6(nspecies, nedge, ngroups, ind, len_vec, anc, des, L, R, painted_edges, phylocovs, REML));
    return rcpp_result_gen;
END_RCPP
}
// theta_Rinv6
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat >::type phylocovs(phylocovsSEXP);
    Rcpp::traits::input_parameter< int >::type REML(REMLSEXP);
    rcpp_result_gen = Rcpp::wrap(theta_Rinv6(nspecies, nedge, ngroups, ind, len_vec, anc, des, L, R, painted_edges, phylocovs, REML));
    return rcpp_result_gen;
END_RCPP
}
// fast_transform
